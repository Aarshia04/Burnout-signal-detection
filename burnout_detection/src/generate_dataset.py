...
This script is retained for backwards compatibility and for anyone who
wants to experiment with completely artificial data.  In the updated
pipeline the primary loader is :mod:`data_loader` which can also consume
real-world datasets such as the Open University Learning Analytics (OULAD)
collection.
"""
import numpy as np
import pandas as pd
